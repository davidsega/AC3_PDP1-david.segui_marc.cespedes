...
const int LE1 = 3;            // pin d'entrada de l'encoder 1 del motor esquerre (INT0)
const int LE2 = 27;           // pin d'entrada de l'encoder 2 del motor esquerre
const int RE1 = 2;            // pin d'entrada de l'encoder 1 del motor dret (INT1)
const int RE2 = 26;           // pin d'entrada de l'encoder 2 del motor dret
